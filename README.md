# IP5356
Some data about the IP5356 component provided by the manufacturer [Yingjixin Technology](https://www.injoinic.com/) (this IC has I2C communication, and can be found in Power Bank with display)
